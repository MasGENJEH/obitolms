...
@section('title', 'Obito | Subscription Detail')
                ...
                <section id="give-access-to" class="flex flex-col gap-2">
                    <div class="flex items-center justify-between rounded-[20px] border border-obito-grey p-[14px]">
                        ...
                        <div class="status flex items-center gap-[14px]">
                            <span
                                class="font-bold text-xs badge w-fit rounded-full py-[6px] px-[10px] gap-[6px] {{ $transaction->ended_at > now() ? 'text-obito-green bg-obito-light-green' : 'text-obito-red bg-obito-light-red' }}">
                                {{ $transaction->ended_at > now() ? 'ACTIVE' : 'EXPIRED' }}
                            </span>
                        </div>
                    </div>
                </section>
