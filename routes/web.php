...
Route::match(['get', 'post'], '/booking/payment/midtrans/notifications', [FrontController::class, 'paymentMidtransNotification'])->name('frons.payment_midtrans_notification');
...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('role:student')->group(function () {
        Route::get('/dashboard/subsciptions/', [DashboardController::class, 'subsciptions'])->name('dashboard.subscriptions');
        Route::get('/dashboard/subsciptions/{transaction}', [DashboardController::class, 'subsciptions'])->name('dashboard.subscriptions.details');
        ...
        Route::middleware(['check.subscription'])->group(function () {
            ...
            Route::get('/dashboard/learning/{course:slug}/{courseSection}/{sectionContent}', [CourseController::class, 'learning'])->name('dashboard.course.join');
